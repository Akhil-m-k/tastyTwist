...
import { clearCart, addItem, removeItem, removeDuplicateItem } from "../utils/cartSlice";
    ...
    <div className="min-h-screen bg-gray-100 pt-28  mb-3">
      ...
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                  ...
                  <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                    <div className="flex items-center border-gray-100">
                      ...
                      <input
                        ...
                        type="number"
                        value={items ? items.filter((ele) => ele.name === item.name).length : "0"}
                        min="1"
                        readOnly
                      />
                      <span
        ...
        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
          ...
          <button className="mt-6 w-full rounded-md bg-orange-500 py-1.5 font-medium text-blue-50 hover:bg-orange-600">Check out</button>
        </div>
      </div>
    </div>
  );
